...
public class Board {
    ...
    public void addRandomTile() {
        int randIndex = StdRandom.uniform(0, openSpaces.size());
        double randVal = StdRandom.uniform(0, 1);
        int r = 0, c = 0;
        if(randVal < 0.1) //4 
        {
            r = (openSpaces.get(randIndex).getRow());
            c = (openSpaces.get(randIndex).getCol());
            gameBoard[r][c] = 4;
        }
        else //2
        {
    ...
    public void swipeLeft() {
        for(int r=0; r<gameBoard.length;r++){
            ...
            for(int c=0; c<gameBoard[r].length;c++){
                if(gameBoard[r][c] == 0){
                    ...
                    if(count >0){
                        gameBoard[r][c-count] = gameBoard[r][c];
                        gameBoard[r][c] =0;
                    }
                }
            }
     ...
     /*
      * or (int r = 0; r < gameBoard.length; r++) {
      ...
      */
    /**
     * Find and merge all identic/al left pairs in the board. Ex: "2 2 2 2" will become "2 0 2 0".
    ...
    public void flipRows() {
        for ( int r = 0; r < gameBoard.length; r++ ) {
            for (int c = 0; c < gameBoard[r].length/2; c++) {
                ...
                gameBoard[r][c] = gameBoard[r][gameBoard[r].length - c -1];
                gameBoard[r][gameBoard[r].length-c-1] = temp;
            } 
